...
if !exists('g:AutoPairsShortcutBackJump')
  let g:AutoPairsShortcutBackJump = '<M-p>'
endif
...
if !exists('g:AutoPairsShortcutBackInsert') && exists('g:AutoPairsFlyMode')
...
func! AutoPairsInit()
  ...
  if g:AutoPairsShortcutBackJump != ''
    execute 'inoremap <buffer> <silent> ' . g:AutoPairsShortcutBackJump. ' <ESC>:call AutoPairsBackJump()<CR>a'
    execute 'noremap <buffer> <silent> ' . g:AutoPairsShortcutBackJump. ' :call AutoPairsBackJump()<CR>'
  end
