...
" Scheme      : maroloccio
" Maintainer  : Marco Ippolito <maroloccio@gmail.com>
" Version     : v0.3.2, originally inspired by watermark.vim
" Date        : 8 May 2013
" Licence     : Feel free to use as you wish provided you keep this header.
" Feedback    : Any feedback welcome! Especially on how to make it better!
" Note        : Works well in GUI mode, less in console mode (still worth a try)
" Online at   : http://www.vim.org/scripts/script.php?script_id=2480
" ------------------------------------------------------------------------------
" History:
"
" 0.3.2 Published to GitHub: https://github.com/Maroloccio/maroloccio-vim
...
hi LineNr         guifg=#3c4148 guibg=#0e1219  gui=none                         " grey on dark grey
