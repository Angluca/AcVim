...
let g:template['c']['ife'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['dstruct'] = "typedef struct ".g:rs."...".g:re." \<cr>{\<cr>".g:rs."...".g:re."\<cr>}".g:rs."...".g:re.";"
let g:template['c']['denum'] = "enum ".g:rs."...".g:re." \<cr>{\<cr>".g:rs."...".g:re."\<cr>};"
let g:template['c']['dunion'] = "union ".g:rs."...".g:re." \<cr>{\<cr>".g:rs."...".g:re."\<cr>};"
